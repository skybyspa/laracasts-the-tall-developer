    ...
    class="p-8">
        ...
        >
            ...
            <div class="flex flex-row-reverse justify-between items-center">
                ...
                <p class="text-amber-600 text-sm">Almond Corporation</p>
            </div>
                ...
                <div x-data="{showDetails: false}">
                    ...
                    <div x-show="showDetails">
                        <p class="text-sm mt-2">At Almond Corporation, the Full Stack Developer will 
                            ...
                            with product, design, and DevOps teams.</p>
